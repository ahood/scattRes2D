function enforceIC_cc(obj)
    ...
    for j = 1:2:obj.Nt-1
        obj.A_cc_blks{j  }(obj.valRows_cc,:) = cont1;
        obj.A_cc_blks{j  }(obj.derRows_cc,:) = deriv1;
        obj.A_cc_blks{j+1}(obj.valRows_cc,:) = cont2;
        obj.A_cc_blks{j+1}(obj.derRows_cc,:) = deriv2;
    end
    for j = 1:obj.Nt
        obj.B_cc_blks{j}([obj.valRows_cc(:); obj.derRows_cc(:)],:) = 0;
    end
