function enforceIC_fc(obj)
    ...
    for j = 1:2:obj.Nt-1
        obj.A_fc_blks{j  }(obj.valRows,:) = continuity;
        obj.A_fc_blks{j  }(obj.derRows,:) = deriv1;
        obj.A_fc_blks{j+1}(obj.valRows,:) = continuity;
        obj.A_fc_blks{j+1}(obj.derRows,:) = deriv2;
    end
    for j = 1:obj.Nt
        obj.B_fc_blks{j}([obj.valRows(:); obj.derRows(:)],:) = 0;
    end
