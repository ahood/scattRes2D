function x = apply_op_no_bcs(obj,x0,E0,VvaluesVec)
...
% B is just the identity.
    ...
    x = x - obj.apply_kron(obj.Dtt,diag(1./obj.s.^2),xhat); % Dtt term
    x = x - (obj.apply_J_kron_Drr_J(xhat) + obj.apply_I_kron_Drr_I(xhat))./...
             obj.ds.^2; % Drr stuff
    DrIxhat = obj.apply_I_kron_Dr_I(xhat);
    DrJxhat = obj.apply_J_kron_Dr_J(xhat);
    x = x - (DrIxhat + DrJxhat).*...
            (1./obj.ss./obj.ds - obj.d2s./obj.ds.^3); % Dr stuff
